...
public class Word2VEC {
	...
	public Word2VEC(){
		try {
			loadGoogleModel("/home/lcr/GoogleNews-vectors-negative300.bin");
		} catch (IOException e) {
	...
	public float getSimiliar(String q1,String q2){
		float dist = 0;
		float[] center = wordMap.get(q1);
		float[] center2 = wordMap.get(q2);
