...
public class ReWriter {
	/***
	 * @author chenruili
	 * @function question + answer -> hypothesis
	 */
	public String combine(String question,String answer){
		String re_question = reWrite(question).get(0);
		String h = re_question.replace("*", answer);
		return h;
	}
	...
	public  ArrayList<String> reWrite(String string){
		...
		if(args.length > 0){
			...
			}else if(type.equals("who's")){
				String whoString = string.substring(3);
				newStringlist = who_type_process(whoString);
			}
	...
	public ArrayList<String> what_type_specialquestion(String[] arg,String str){
		...
		for(int i = 0;i < posArg.length;i++){
			if((posArg[i].equals("IN") || posArg[i].equals("TO"))&&in_flag){
				in_index = i;
				in_flag = false;
	...
	public   ArrayList<String> what_type_process(String str){
		...
		if(arg.length > 0){
			 ...
			 */
			else if(arg[0].equals("will")||arg[0].equals("would")||arg[0].equals("can")||arg[0].equals("could")){
	...
	public   ArrayList<String> how_type_numberquestion(String[] arg){
		...
		String[] newarg = str.split(" "); 
		if(insert_index != -1){
			if(newarg[insert_index].equals("does")||newarg[insert_index].equals("did")||newarg[insert_index].equals("do")){
				String type = "";
				String newString = "";
	...
	public   ArrayList<String> who_type_process(String str){
		...
		String[] arg = str.split(" ");
		if(arg.length > 0){
			if(arg[0].equals("is")||arg[0].equals("was")||arg[0].equals("are")||arg[0].equals("were")||arg[0].equals("'s")){
